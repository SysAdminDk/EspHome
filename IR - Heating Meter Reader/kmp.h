...
// Kamstrup meter registers
// The registers we want to get out of the meter
const unsigned int registerIds[] = {
    0x003C, // 60 - Heat energy [0]
    0x0050, // 80 - Current power [1]
    0x0056, // 86 - Current forward temperature [2]
    0x0057, // 87 - Current return temperature [3]
    0x0059, // 89 - Current differential temperature [4]
    0x004A, // 74 - Current water flow [5]
    0x0044, // 68 - Volume register V1 [6]
    0x03EC, // 1004 - Hourcounter [7]
    0x03E9  // Serial number [8] 
};
...
static const char *TAG = "Multical Meter";
